...
> "This Project uses the BLKOUT community-web-design skill (synced 2026-02-07). If you've updated the skill recently, you can refresh it from: https://github.com/BLKOUTUK/claude-skills/tree/main/for-claude-ai/community-web-design"
>
> **To get the latest version**, visit:
> https://raw.githubusercontent.com/BLKOUTUK/claude-skills/main/for-claude-ai/community-web-design/instructions.md
> Select all -> Copy -> Replace this Project's instructions -> Paste -> Save
>
> **Knowledge files in this Project:**
> This skill also uses uploaded knowledge files for pattern libraries (landing pages, interactive tools, visual systems). Update those from the same GitHub directory.
...
| File | Contents |
|------|----------|
| `patterns-landing.md` | HTML/Tailwind patterns for campaign pages, coalition pages, investor pages, manifestos, content showcases |
| `patterns-interactive.md` | React patterns for surveys, quizzes, directories, sign-up forms, competitions |
| `visual-systems.md` | Colour palettes (4 contexts), typography systems (3 pairings), type scale, spacing, accessibility checklist, component patterns |
